...
class BuildOnBoardingPage2 extends StatefulWidget {
  const BuildOnBoardingPage2({
    super.key,
  });

  @override
  State<BuildOnBoardingPage2> createState() => _BuildOnBoardingPage2State();
}

class _BuildOnBoardingPage2State extends State<BuildOnBoardingPage2> {
  @override
