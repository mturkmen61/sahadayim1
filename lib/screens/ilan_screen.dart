    ...
    return GetBuilder<ProfileScreenController>(builder: (_) {
      return Scaffold(
        appBar: AppBar(
          ...
          title: const Text(
            "ilanlar",
            style: TextStyle(color: AppColors.darkGreen,fontFamily: "Lato",fontSize: 16),
          ),
          centerTitle: true,
            ...
            Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildCategoryButton("Takımına oyuncu", "assets/images/Group.svg"),
                    const SizedBox(width: 12), // Adjust gap between buttons
                    _buildCategoryButton("Takımına rakip bulmak", "assets/images/top.svg"),
